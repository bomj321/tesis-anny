...
<div class="container">
    ...
    <div id="part-1-case-1">
        ...
        <div class="row mt-4">
            <div
                ...
                <button type="button" class="btn btn-lg btn-danger" id="button-next-part-2-case-1">No</button>
            </div>
        </div>
    ...
    <div id="part-3-case-1" class="hidden-section">
        ...
        <div class="row mt-4">
            <div
                ...
                <button type="button" class="btn btn-lg btn-danger" id="button-next-part-4-case-1">No</button>
            </div>
        </div>
    ...
    <div id="part-5-case-1" class="hidden-section">
